...
from patient.services import get_all_patients, get_patient_by_ID, create_new_patient, edit_patient_record, create_next_of_kin_rec, get_all_next_of_kin_record
...
# This endpoint create new next of kin record
@patient_endpoint.post("new-next-of-kin",status_code=status.HTTP_200_OK)
def Add_new_next_of_kin_recod(db:db_dependency,value:Insert_Next_Of_Kin):
    return create_next_of_kin_rec(db=db,new_record=value)
